        ...
        <!-- end preloader -->
             ...
             <div class="tp-login-area">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="tp-accountWrapper" action="{{ route('pass.reset.confirm',$token) }}" method="POST">
                                @csrf
                                ...
                                <div class="tp-accountForm form-style">
                                    <div class="fromTitle">
                                        ...
                                        @if (session('send'))
                                            <div class="alert-success">{{ session('send') }}</div>
                                        @endif
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            <input type="password" name="password" id="email" placeholder="demo@gmail.com">

                                            <label>Confirm Password</label>
                                            <input type="text" name="password_confirmation" id="email" placeholder="demo@gmail.com">
                                            @error('email')
                                                <strong class="text-danger">{{ $message }}</strong>
                                            @enderror
                                            @if (session('wrong'))
                                                <div class="alert-danger">{{ session('wrong') }}</div>
                                            @endif
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-12">
